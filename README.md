...
onChange | function | oop | callback which being trigger once image is being changed (scale, top, left)
scale | number | 1 | the scale of the image
left | number | 0 | the left position
top | number | 0 | the top position
